...
class NewsController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        if($request->isPost())
        {
            ...
            {
                echo "<div class = \"ui-widget\" style = \"margin: 50px 0 0 5px;font-size: 0.8em\"><div class = \"ui-state-error ui-corner-all\"><p style = \"text-align:center\"><span class = \"ui-icon-alert\" style = \"float: left\"></span>Wypełnij wszystkie wymagane pola!</p></div></div>";
